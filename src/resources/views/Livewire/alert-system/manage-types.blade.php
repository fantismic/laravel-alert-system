            ...
            @foreach ($types as $type)
                <tr
                    ...
                    <td class="p-2 space-x-2">
                        <button wire:click="edit({{ $type->id }})" class="text-blue-500 hover:underline">Edit</button>
                        <button wire:click="delete({{ $type->id }})" class="text-red-500 hover:underline">Delete</button>
                    </td>
                </tr>
            @endforeach
        </tbody>
